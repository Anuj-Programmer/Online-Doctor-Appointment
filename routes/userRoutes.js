...
const { registerController, loginController, authController, markAllNotifications, deleteAllNotifications, bookAppointment, searchDoctor, getUserAppointments, rescheduleAppointment, cancelAppointment, getBookedSlots, sendOtpController, verifyOtpController } = require('../controllers/userCtrl');
...
// OTP Sending Route || POST
router.post('/send-otp', sendOtpController);  // Added send OTP route

// OTP Verification Route || POST
router.post('/verify-otp', verifyOtpController);  // Added verify OTP route
