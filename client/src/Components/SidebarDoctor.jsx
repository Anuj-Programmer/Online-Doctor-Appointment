  ...
  return (
    ...
    <div className="doctor-profile">
            <div className="profile-image-wrapper">
              {/* <img
                src={doctorData?.photo || "https://cdn.builder.io/api/v1/image/assets/TEMP/734139f1ce387c192d9fd781b4f57cfa703fc940"}
                alt="Doctor profile"
            ...
            <div className="profile-info">
              <h2 className="doctor-name">Dr. {doctorData?.firstName} {doctorData?.lastName}</h2>
          ...
          <nav className="sidebar-nav">
            <div 
              className={`nav-item-doctor ${activeTab === 'dashboard' ? 'active' : ''}`}
            ...
            <div 
              className={`nav-item-doctor ${activeTab === 'appointments' ? 'active' : ''}`}
            ...
            <div 
              className={`nav-item-doctor ${activeTab === 'schedule' ? 'active' : ''}`}
